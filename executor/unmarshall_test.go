...
func TestTmpMarshall(t *testing.T) {
	// {"serviceAccount":"{myservice:achilio-dev@achilio.com}","queries":[{"mmvName":"achilio_1234","datasetName":"mydataset1","statement":"SELECT1"}]}
	i1 := `{
		"message": {
			"attributes": {
				"accessToken": "value",
			...
			"data": "eyJzZXJ2aWNlQWNjb3VudCI6IntteXNlcnZpY2U6YWNoaWxpby1kZXZAYWNoaWxpby5jb219IiwicXVlcmllcyI6W3sibW12TmFtZSI6ImFjaGlsaW9fMTIzNCIsImRhdGFzZXROYW1lIjoibXlkYXRhc2V0MSIsInN0YXRlbWVudCI6IlNFTEVDVDEifV19",
			"messageId": "2070443601311540",
			"message_id": "2070443601311540",
			"publishTime": "2021-02-26T19:13:55.749Z",
			"publish_time": "2021-02-26T19:13:55.749Z"
	...
	if r1.Message.Attributes.ServiceAccount != "{myservice:achilio-dev@achilio.com}" {
		log.Fatalf("Expected %s, got %s", "{myservice:achilio-dev@achilio.com}", r1.Message.Attributes.ServiceAccount)
	}
}
