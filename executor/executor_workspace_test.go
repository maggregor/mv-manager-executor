...
func TestSetCommandWorkspace1(t *testing.T) {
	a1 := Attributes{ServiceAccount: "myAccessToken", ProjectID: "myprojectid", CmdType: "workspace", Queries: nil}
...
func TestSetCommandWorkspace2(t *testing.T) {
	a1 := Attributes{ServiceAccount: "myAccessToken", ProjectID: "myprojectid", CmdType: "apply", Queries: nil}
	executor := &WorkspaceExecutor{a1, ""}
